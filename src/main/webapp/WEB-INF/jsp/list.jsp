        ...
        <div class="col-md-3 column">
            ...
            <div class="panel panel-primary">
                ...
                <c:forEach items="${params.categories}" var="cate">
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/list?cid=${cate.cid}">${fn:escapeXml(cate.cname)}(${cate.count})</a></li>
                </c:forEach>
                </ul>
            </div>
            ...
            <div class="panel panel-primary">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="http://www.itfenghui.com/" title="SEO">SEO</a></li>
                </ul>
            </div>
        </div>
    </div>
