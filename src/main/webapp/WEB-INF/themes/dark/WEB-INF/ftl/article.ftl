                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <#list categoryList as cl>
                                <li><a href="${contextPath}/list?cid=${cl.cid}">${cl.cname}</a></li>
                            </#list>
                        </ul>
                    </li>
                    <li>
...
<div class="wrapper">
    ...
    <div class="content box" style="width: 96%;">
        ...
        <div class="info">
            <div><a href="${contextPath}/list?cid=${article.cid}" title="查看该类型博文"><i class="icon-folder-open-alt"></i>：${category.cname}</a></div>
            <div><a href="#"><i class="icon-user"></i>：${article.author}</a></div>
            <div><i class="icon-time"></i>：${article.time?string("yyyy-MM-dd HH:mm")}</div>
        </div>
        ${typeString}
        ${article.content}
        ${typeString}
        <div class="record">
            ...
            <a class="comment-btn" href="javascript:onComment('${contextPath}/comment')"><i class="icon-comments"></i> 给我留言</a>
        </div>
        <div class="last-next">
            <div>
