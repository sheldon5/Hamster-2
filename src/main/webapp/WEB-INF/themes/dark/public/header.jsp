      ...
      <div id="menu" class="menu">
        <ul id="tiny">
          <li class="active">
            ...
            <ul>
              <li><a href="${pageContext.request.contextPath}/list">所有博文</a></li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a href="${pageContext.request.contextPath}/comment" title="给我留言">留言板</a>
          </li>
          <li><a href="#">Menu</a>
            <ul>
...
<div class="wrapper">
  <ul class="social">
    <li><a class="rss" href="${pageContext.request.contextPath}/rss/" title="博客订阅"></a></li>
    ...
    <li><a class="wechat" href="${pageContext.request.contextPath}/public/wechat.html" title="微信"></a></li>
